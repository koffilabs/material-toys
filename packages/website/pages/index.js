        ...
        <div className="container">
          ...
          <main>
            ...
            <div>
              ...
              <FAB className="level1 large">
                <EditIcon size="36px" />
              </FAB>
              <FAB className="level1 small">
                <EditIcon />
              </FAB>
              <FAB className="level1 small" disabled>
                <EditIcon />
              </FAB>
            </div>
            <div>
              ...
              <ExtendedFAB className="surface">Compose</ExtendedFAB>
              <ExtendedFAB className="secondary">Compose</ExtendedFAB>
              <ExtendedFAB className="tertiary">Compose</ExtendedFAB>
            </div>
            <div>
